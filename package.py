...
class SpackExercise(CMakePackage):
    """Provides a spack package for the packaging exercise in SSE lecture WS 2021/22. See the homepage for details on te content. Basically, it's a HelloWorld for packaging with spack and some dependencies."""
    ...
    # We don't need to specify additional arguments to CMake.
    # Thus, we can remove the cmake_args function.
    # def cmake_args(self):
